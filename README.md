...
7. Open the Detection Rules section in the dashboard.
8. Create a test rule from the web interface.
9. Press d in the launcher.
10. Choose logs/bruteforce.txt.
11. Show failed login events in the dashboard.
12. Show alerts generated by the rule engine.
13. Edit or disable the test rule from the dashboard.
14. Delete the test rule from the dashboard.
15. Press d again.
16. Choose logs/sudo_test.txt.
17. Show privilege escalation events and sudo frequency alerts.
18. Show system_event entries from syslog or kern.log.
19. Show rule-based syslog alerts such as RULE_APPARMOR_DENIED.
20. Press s to open the full server log.
21. Press a to open the full agent log.
22. Press q to stop everything.
```
